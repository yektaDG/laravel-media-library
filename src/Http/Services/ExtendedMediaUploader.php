...
namespace YektaDG\Medialibrary\Http\Services;
...
class ExtendedMediaUploader
{
    ...
    public function upload(): Media
    {
        ...
        if (str_contains($model->mime_type, 'image')) {
    ...
    private function generateFilename(): string
    {
        ...
        if ($this->hashFilename) {
            ...
            } while (Media::where('filename', $hash)->first() != null);
